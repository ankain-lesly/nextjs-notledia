      ...
      <section id="faq" className="section-p bg-light">
        <main className="container-x">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-center text-[38px] md:text-4xl leading-10 font-extrabold md:leading-[3.2rem] mb-10 lcg_scroll from_scale lcg_animate">
              Next Step
            </h1>
            ...
            <div className="text-center mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <p className="text-dark/80">
                    Get smart suggestions and organize your thoughts
                    effortlessly.
                  </p>
                </div>
              </div>
