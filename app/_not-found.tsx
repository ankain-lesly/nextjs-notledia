...
const NotFound = () => {
  ...
  return (
    <main>
      ...
      <div className="relative flex flex-col justify-around min-h-screen items-center sm:pt-0 bg-white">
        <ScreenWrapper ngClass="flex-center flex-col gap-4">
          ...
          <p className="max-w-sm text-center">
            Looks like the page you are trying to access is not available.
            Proceed with
          </p>
          <div className="flex-center flex-col gap-4">
            ...
            <Link
              className="text-center block text-primary mx-auto"
              href={"/shop"}>
              Continue Shopping
            </Link>
          </div>
